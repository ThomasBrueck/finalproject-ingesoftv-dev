...
class RedisBatchUpdateTest {
    ...
    @Test
    void shouldBatchUpdateRedis() {
        String anonymousId = "user-batch-2001";
        ...
        verify(valueOperations, atLeast(2)).multiSet(ArgumentMatchers.anyMap());
    }

    @Test
    void shouldHandleEmptyBatch() {
        String anonymousId = "user-batch-empty";
